...
public:
    ...
    static Redis* NewRedis(const ConnectionOptions& connection_opts, const ConnectionPoolOptions& pool_opts);
    static void DeleteRedis(Redis*& pRedis);
