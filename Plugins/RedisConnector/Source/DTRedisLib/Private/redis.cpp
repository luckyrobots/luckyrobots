...
Redis* Redis::NewRedis(const ConnectionOptions& connection_opts, const ConnectionPoolOptions& pool_opts)
{
    return new Redis(connection_opts, pool_opts);
}

void Redis::DeleteRedis(Redis*& pRedis)
{
    if (pRedis != nullptr)
    {
        delete pRedis;
